            ...
            >
              ...
              <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-start">
                ...
                <div className="flex gap-2">
                  <button
                    onClick={() => navigate(`/teacher/lesson-ai/${lesson.id}`, { state: { lesson } })}
                    className="inline-flex items-center gap-1.5 rounded-lg bg-indigo-100 px-3 py-2 text-sm font-medium text-indigo-600 hover:bg-indigo-200 dark:bg-indigo-900/30 dark:text-indigo-400"
                  >
                    <MdAutoAwesome className="h-4 w-4" /> SI dars yaratish
                  </button>
                  <button
